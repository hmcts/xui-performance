...
class XUI_Simulation extends Simulation {
  ...
  val orderData = csv("OrderData.csv").circular
	...
	val prlC100TargetPerHour: Double = 70
  ...
  val prlC100LATargetPerHour: Double = 42
...
* XUI Add LA to C100 Scenario
===============================================================================================*/
  val PRLC100LAExtensionScenario = scenario("***** Private Law LA Extension Tasks *****")
    .exitBlockOnFail {
...
* XUI Add LA to C100 Scenario
===============================================================================================*/
  val PRLC100LATransferScenario = scenario("***** Private Law LA Transfer Tasks *****")
    .exitBlockOnFail {
      feed(LADataTransfer)
        .feed(UserFeederPRLCourtAdmin)
        .exec(_.set("env", s"${env}")
...
* XUI Add LA to C100 Scenario
===============================================================================================*/
  val PRLC100LAOrderScenario = scenario("***** Private Law LA Order Tasks *****")
    .exitBlockOnFail {
      feed(orderData)
        .feed(UserFeederPRLCourtAdmin)
        .exec(_.set("env", s"${env}")
...
* XUI Barrister Private Law FL401 Scenario
  ...
  * Simulation Configuration
  ...
  setUp(
    ...
    //PRLFL401SolicitorScenario.inject(rampUsers(5).during(30.minutes)),
