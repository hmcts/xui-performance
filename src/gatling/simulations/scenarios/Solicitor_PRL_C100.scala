  ...
  val ChildrenAndOtherPeople = 
    ...
    group("XUI_PRL_C100_510_ChildrenAndOtherPeople") {
      ...
      .exec(http("XUI_PRL_C100_510_010_ChildrenAndOtherPeople")
        ...
        .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.ui-start-event-trigger.v2+json;charset=UTF-8")
        .check(jsonPath("$.event_token").saveAs("event_token"))
        .check(jsonPath("$.case_fields[?(@.id=='buffChildAndOtherPeopleRelations')].value[0].value.otherPeopleFullName").find.saveAs("otherPeopleFullName0"))
        .check(jsonPath("$.case_fields[?(@.id=='buffChildAndOtherPeopleRelations')].value[0].value.otherPeopleId").find.saveAs("otherPeopleSubId0"))
        .check(jsonPath("$.case_fields[?(@.id=='buffChildAndOtherPeopleRelations')].value[0].value.childFullName").find.saveAs("childFullName"))
        .check(jsonPath("$.case_fields[?(@.id=='buffChildAndOtherPeopleRelations')].value[0].value.childId").find.saveAs("childId"))
        .check(jsonPath("$.case_fields[?(@.id=='buffChildAndOtherPeopleRelations')].value[0].id").find.saveAs("otherPeopleId0"))
        .check(jsonPath("$.case_fields[?(@.id=='buffChildAndOtherPeopleRelations')].value[1].value.otherPeopleFullName").find.saveAs("otherPeopleFullName1"))
        .check(jsonPath("$.case_fields[?(@.id=='buffChildAndOtherPeopleRelations')].value[1].value.otherPeopleId").find.saveAs("otherPeopleSubId1"))
        .check(jsonPath("$.case_fields[?(@.id=='buffChildAndOtherPeopleRelations')].value[1].id").find.saveAs("otherPeopleId1"))
