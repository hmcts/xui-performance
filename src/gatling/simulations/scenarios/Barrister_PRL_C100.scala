...
import scenarios.Solicitor_FR.{MaxThinkTime, MinThinkTime}
...
object Barrister_PRL_C100 {
  ...
  val AddDocumentC100Applicant =
    ...
    * Run Manage Document task
    ...
    group("XUI_PRL_C100progress_200_ApplicantAddDocument") {
  ...
  val AddDocumentC100Respondent =
    ...
    * Run Manage Document task
    ...
    group("XUI_PRL_C100progress_200_RespondentAddDocument") {
