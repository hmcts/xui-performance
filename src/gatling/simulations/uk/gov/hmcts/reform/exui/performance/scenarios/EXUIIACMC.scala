  ...
  val iaccasecreation=
    tryMax(2) {
      ...
      .exec(http("XUI${service}_070_StartAppealHomeOfficeDecision")
        ...
        .body(StringBody("{\n  \"data\": {\n    \"homeOfficeReferenceNumber\": \"A1289136/009\",\n    \"homeOfficeDecisionDate\": \"${currentDate}\"\n  },\n  \"event\": {\n    \"id\": \"startAppeal\",\n    \"summary\": \"\",\n    \"description\": \"\"\n  },\n  \"event_token\": \"${event_token}\",\n  \"ignore_warning\": false,\n  \"event_data\": {\n    \"checklist\": {\n      \"checklist5\": [\n        \"isResidingInUK\"\n      ],\n      \"checklist2\": [\n        \"isNotDetained\"\n      ],\n      \"checklist7\": [\n        \"isNotEUDecision\"\n      ]\n    },\n    \"homeOfficeReferenceNumber\": \"A1289136/009\",\n    \"homeOfficeDecisionDate\": \"${currentDate}\"\n  }\n}"))
    ...
    .pause(MinThinkTime , MaxThinkTime )
      ...
      .exec(http("XUI${service}_190_020_IsAuthenticated")
      ...
      .exec(http("XUI${service}_200_010_IsAuthenticated")
        .get("/auth/isAuthenticated")
        .headers(IACHeader.headers_isauthenticatedsubmit)
        .check(status.in(200,304,302)))

      .exec(http("XUI${service}_200_010_UserDetails")
            .get("/api/user/details")
            .headers(IACHeader.headers_isauthenticatedsubmit)
            .check(status.in(200,304,302)))

      .exec(http("XUI${service}_200_010_DataInternalProfile")
            .get("/data/internal/profile")
