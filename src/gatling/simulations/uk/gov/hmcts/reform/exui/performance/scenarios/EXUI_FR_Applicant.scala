...
object EXUI_FR_Applicant extends Simulation {
	...
	val createCase = scenario("CreateCase")
		...
		.exec(http("XUI${service}_070_CreateSolicitor1")
			...
			.headers(headers_10)
			.body(ElFileBody("RecordedSimulationFRApplicant_0010_request.txt"))
			.check(status in (200,304)))
		.pause(minThinkTime, maxThinkTime)
		...
		.exec(http("XUI${service}_090_CreateSolicitor2")
			...
			.headers(headers_18)
			.body(ElFileBody("RecordedSimulationFRApplicant_0018_request.txt"))
			.check(status in (200,304)))
		.pause(minThinkTime, maxThinkTime)
		...
		.exec(http("XUI${service}_100_CreateSolicitor3")
			...
			.headers(headers_22)
			.body(ElFileBody("RecordedSimulationFRApplicant_0022_request.txt"))
			.check(status in (200,304)))
		.pause(minThinkTime, maxThinkTime)
		...
		.exec(http("XUI${service}_110_CreateSolicitor4")
			...
			.headers(headers_26)
			.body(ElFileBody("RecordedSimulationFRApplicant_0026_request.txt"))
			.check(status in (200,304)))
		.pause(minThinkTime, maxThinkTime)
		...
		.exec(http("XUI${service}_140_CreateSolicitor5")
			...
			.headers(headers_34)
			.body(ElFileBody("RecordedSimulationFRApplicant_0034_request.txt"))
			.check(status in (200,304)))
		.pause(minThinkTime, maxThinkTime)
		...
		.exec(http("XUI${service}_150_CreateSolicitor6")
			...
			.headers(headers_37)
			.body(ElFileBody("RecordedSimulationFRApplicant_0037_request.txt"))
			.check(status in (200,304)))
		.pause(minThinkTime, maxThinkTime)
		...
		.exec(http("XUI${service}_170_CreateSolicitor8")
			...
			.headers(headers_44)
			.body(ElFileBody("RecordedSimulationFRApplicant_0044_request.txt"))
			.check(status in (200,304)))
		.pause(minThinkTime, maxThinkTime)
		...
		.exec(http("XUI${service}_190_CreateSolicitor9")
			...
			.headers(headers_51)
			.body(ElFileBody("RecordedSimulationFRApplicant_0051_request.txt"))
			.check(status in (200,304)))
		.pause(minThinkTime, maxThinkTime)
		...
		.exec(http("XUI${service}_200_CreateSolicitor11")
			...
			.headers(headers_55)
			.body(ElFileBody("RecordedSimulationFRApplicant_0055_request.txt"))
			.check(status in (200,304)))
		.pause(minThinkTime, maxThinkTime)
		...
		.exec(http("XUI${service}_210_CreateSolicitor12")
			...
			.headers(headers_59)
			.body(ElFileBody("RecordedSimulationFRApplicant_0059_request.txt"))
			.check(status in (200,304)))
		.pause(minThinkTime, maxThinkTime)
		...
		.exec(http("XUI${service}_230_CreateCase6")
			...
			.headers(headers_64)
			.body(ElFileBody("RecordedSimulationFRApplicant_0064_request.txt"))
