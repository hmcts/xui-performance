...
.group("XUI${service}_090_CreateApplication2")
  {
    ...
    .exec(http("XUI${service}_090_010_Draft")
  ...
  .check(status.in(400,200,201)))
    ...
    .exec(http("XUI${service}_090_015_DraftProfile")
      .get("/data/internal/profile")
  ...
  .group("XUI${service}_100_CaseSubmitted") {
