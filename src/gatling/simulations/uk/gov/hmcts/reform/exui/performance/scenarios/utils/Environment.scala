...
object Environment {
 ...
 val baseDomain="manage-case.perftest.platform.hmcts.net"
  ...
  //10
  val maxThinkTimeIACC = 6//120
  val minThinkTimeFPLV = 5//340
  //10
  val maxThinkTimeFPLV = 6//345
  //320
  val minThinkTimeIACV = 5//470
  //10
  val maxThinkTimeIACV = 6//490
  val minThinkTimePROB = 5//300
  //10
  val maxThinkTimePROB = 6//310
