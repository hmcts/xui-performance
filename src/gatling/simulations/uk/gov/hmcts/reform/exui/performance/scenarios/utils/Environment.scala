...
val baseDomainOrg="manage-org.perftest.platform.hmcts.net"
 ...
 val minThinkTime = 10//100
  ...
  //30
  val minThinkTimeFPLC = 10//60//75
  //10
  val maxThinkTimeFPLC = 10//65//80

  val minThinkTimeSDO = 100
  //10
  val maxThinkTimeSDO = 110
  //30
  val minThinkTimeIACC = 10//90//100
  //10
  val maxThinkTimeIACC = 10//100//120
  ...
  val minThinkTimePROB = 10//340//300
  val maxThinkTimePROB = 10//360//310

  val minThinkTimeDIV = 10//100//140
  val maxThinkTimeDIV = 10//110//160

  val minThinkTimeCW = 10//40//50
  val maxThinkTimeCW = 10//42//50

  val minThinkTimeFR =10//90//  100
  val maxThinkTimeFR =10//95//48//100
