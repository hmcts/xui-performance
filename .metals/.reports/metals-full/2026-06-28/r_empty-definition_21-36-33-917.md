error id: file://<WORKSPACE>/src/gatling/simulations/utils/Common.scala:format.
file://<WORKSPACE>/src/gatling/simulations/utils/Common.scala
...
non-local guesses:
	 ...
	 -scala/Predef().
offset: 1267
uri: file://<WORKSPACE>/src/gatling/simulations/utils/Common.scala
text:
```scala
package utils
...
object Common {
  ...
  * Common Utility Functions
  ...
  def getMonth(): String = {
    (1 + rnd.nextInt(12)).toString.for@@mat(patternMonth).reverse.padTo(2, '0').reverse //pads single-digit dates with a leading zero
  }
