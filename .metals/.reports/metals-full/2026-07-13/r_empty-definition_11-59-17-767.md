error id: file://<WORKSPACE>/src/gatling/simulations/simulations/XUI_Simulation.scala:
file://<WORKSPACE>/src/gatling/simulations/simulations/XUI_Simulation.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -io/gatling/core/Predef.simulationProfile.
	 -io/gatling/core/Predef.simulationProfile#
	 -io/gatling/core/Predef.simulationProfile().
	 -io/gatling/http/Predef.simulationProfile.
	 -io/gatling/http/Predef.simulationProfile#
	 -io/gatling/http/Predef.simulationProfile().
	 -scenarios/simulationProfile.
	 -scenarios/simulationProfile#
	 -scenarios/simulationProfile().
	 -utils/simulationProfile.
	 -utils/simulationProfile#
	 -utils/simulationProfile().
	 -xui/simulationProfile.
	 -xui/simulationProfile#
	 -xui/simulationProfile().
	 -scala/concurrent/duration/simulationProfile.
	 -scala/concurrent/duration/simulationProfile#
	 -scala/concurrent/duration/simulationProfile().
	 -simulationProfile.
	 -simulationProfile#
	 -simulationProfile().
	 -scala/Predef.simulationProfile.
	 -scala/Predef.simulationProfile#
	 -scala/Predef.simulationProfile().
offset: 25558
uri: file://<WORKSPACE>/src/gatling/simulations/simulations/XUI_Simulation.scala
text:
```scala
package simulations
...
//			.exec(Solicitor_PRL_FL401.HearingsTab)
  ...
  setUp(
      ...
      FinancialRemedySolicitorConsentedScenario.inject(simulationProfile(testType, frConsentedTargetPerHour, numberOfPipelineUsers)).pauses(pauseOption),
			FinancialRemedySolicitorContestedScenario.inject(simulationProfi@@le(testType, frContestedTargetPerHour, numberOfPipelineUsers)).pauses(pauseOption),
