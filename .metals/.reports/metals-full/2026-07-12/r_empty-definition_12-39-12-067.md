error id: file://<WORKSPACE>/src/gatling/simulations/scenarios/CCNotes.scala:Environment.
file://<WORKSPACE>/src/gatling/simulations/scenarios/CCNotes.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -io/gatling/core/Predef.Environment.
	 -io/gatling/http/Predef.Environment.
	 -scala/concurrent/duration/Environment.
	 -utils/Environment.
	 -Environment.
	 -scala/Predef.Environment.
offset: 2098
