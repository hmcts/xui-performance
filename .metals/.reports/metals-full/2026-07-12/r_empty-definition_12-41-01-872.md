error id: file://<WORKSPACE>/src/gatling/simulations/scenarios/CCNotes.scala:
file://<WORKSPACE>/src/gatling/simulations/scenarios/CCNotes.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -io/gatling/core/Predef.substring.
	 -io/gatling/core/Predef.substring#
	 -io/gatling/core/Predef.substring().
	 -io/gatling/http/Predef.substring.
	 -io/gatling/http/Predef.substring#
	 -io/gatling/http/Predef.substring().
	 -scala/concurrent/duration/substring.
	 -scala/concurrent/duration/substring#
	 -scala/concurrent/duration/substring().
	 -substring.
	 -substring#
	 -substring().
	 -scala/Predef.substring.
	 -scala/Predef.substring#
	 -scala/Predef.substring().
offset: 2841
