error id: file://<WORKSPACE>/src/gatling/simulations/scenarios/CCNotes.scala:group.
file://<WORKSPACE>/src/gatling/simulations/scenarios/CCNotes.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -io/gatling/core/Predef.group.
	 -io/gatling/core/Predef.group#
	 -io/gatling/core/Predef.group().
	 -io/gatling/http/Predef.group.
	 -io/gatling/http/Predef.group#
	 -io/gatling/http/Predef.group().
	 -scala/concurrent/duration/group.
	 -scala/concurrent/duration/group#
	 -scala/concurrent/duration/group().
	 -group.
	 -group#
