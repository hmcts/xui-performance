error id: file://<WORKSPACE>/src/gatling/simulations/scenarios/CCNotes.scala:core.
file://<WORKSPACE>/src/gatling/simulations/scenarios/CCNotes.scala
empty definition using pc, found symbol in pc: core.
...
// WARN: Script not converted: JSR223 Samplpackage scenarios

import io.gatling.co@@re.Predef._
...
.doWhile(session => !session.contains("caseOpened")) {
.tryMax(3) {
